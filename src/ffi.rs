...
#[no_mangle]
pub unsafe extern fn ffsvm_context_create(context_ptr: *mut *mut Context) -> i32 {
...
#[no_mangle]
pub unsafe extern fn ffsvm_set_max_problems(context_ptr: *mut Context, max_problems: u32) -> i32 {
    if context_ptr.is_null() { return Errors::NullPointerPassed as i32; }
...
#[no_mangle]
pub unsafe extern fn ffsvm_predict_values(context_ptr: *mut Context, features_ptr: *mut f32, features_len: u32, labels_ptr: *mut u32, labels_len: u32) -> i32 {
    if context_ptr.is_null() { return Errors::NullPointerPassed as i32; }
...
#[no_mangle]
pub unsafe extern fn ffsvm_context_destroy(context_ptr: *mut *mut Context) -> i32 {
    if context_ptr.is_null() { return Errors::NullPointerPassed as i32; }
