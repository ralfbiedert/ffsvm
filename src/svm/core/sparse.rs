...
use crate::{errors::Error, parser::ModelFile, svm::{
    class::Class,
    kernel::{KernelSparse, Linear, Poly, Rbf, Sigmoid},
    predict::Predict,
    problem::{Problem, Solution},
    Probabilities, SVMType,
}, util::{find_max_index, set_all, sigmoid_predict}, vectors::Triangular};
...
impl SparseSVM {
    ...
    pub(crate) fn compute_multiclass_probabilities(&self, problem: &mut Problem<SparseVector<f32>>) -> Result<(), Error> {
