...
mod svm_dense_regression {
    ...
    test_model!(m_e_svr_linear, "m_e_svr_linear.libsvm", false, [0.369_232, 7.1004], []);
    test_model!(m_e_svr_poly, "m_e_svr_poly.libsvm", false, [2.71936, 6.89966], []);
    test_model!(m_e_svr_rbf, "m_e_svr_rbf.libsvm", false, [0.581_717, 6.39637], []);
    test_model!(m_e_svr_sigmoid, "m_e_svr_sigmoid.libsvm", false, [0.026_749_1, 5.26548], []);
    ...
    test_model!(m_nu_svr_linear, "m_nu_svr_linear.libsvm", false, [0.471_485, 7.05909], []);
    test_model!(m_nu_svr_poly, "m_nu_svr_poly.libsvm", false, [2.18783, 6.55455], []);
    test_model!(m_nu_svr_rbf, "m_nu_svr_rbf.libsvm", false, [0.653_419, 6.49803], []);
    test_model!(m_nu_svr_sigmoid, "m_nu_svr_sigmoid.libsvm", false, [0.396_866, 5.52985], []);
